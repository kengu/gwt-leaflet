...
public class IControlImpl  {
	...
	public static native JSObject onAdd(Control control, JSObject self)/*-{
		self.onAdd=function(map){
		  			return control.@org.discotools.gwt.leaflet.client.controls.Control::onAdd(Lcom/google/gwt/core/client/JavaScriptObject;)(map);
			};
	}-*/;	
	
	public static native JSObject onRemove(Control control, JSObject self)/*-{
		self.onRemove=function(map){
	  			control.@org.discotools.gwt.leaflet.client.controls.Control::onRemove(Lcom/google/gwt/core/client/JavaScriptObject;)(map);
		};
	}-*/;	
